...
const stripe_service_1 = require("../../integrations/stripe/stripe.service");
const order_service_1 = require("../order/order.service");
let PaymentWebhookController = class PaymentWebhookController {
    stripeService;
    orderService;
    constructor(stripeService, orderService) {
...
], PaymentWebhookController.prototype, "handleStripeWebhook", null);
